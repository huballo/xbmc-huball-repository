...
###Dragonball##
    if section == 'dragonball':
        ...
        _addon.add_directory({'mode': 'dragonball', 'site': site, 'section': section, 'url': 'https://strefadb.pl/odcinki/db_gt.html'}, {'title': 'Dragon Ball GT'}, is_folder=True, fanart=fanartdragon, img='https://images-na.ssl-images-amazon.com/images/M/MV5BYzY3YjhiYTMtNDQ4OS00ZGI0LWE0ODQtOGM1N2M5OTQyNjk1XkEyXkFqcGdeQXVyMjc2Nzg5OTQ@._V1_.jpg')
        ...
        _addon.add_directory({'mode': 'dragonball', 'site': site, 'section': section, 'url': 'https://strefadb.pl/odcinki/db_super.html'}, {'title': 'Dragon Ball Super'}, is_folder=True, fanart=fanartdragon, img='https://images-na.ssl-images-amazon.com/images/M/MV5BY2I2MzI1ODYtMWRlOS00MzdhLWEyOWEtYWJhNmFiZTIxMGJhXkEyXkFqcGdeQXVyMTExNDQ2MTI@._V1_SY1000_CR0,0,666,1000_AL_.jpg')
        _addon.add_directory({'mode': 'dragonball', 'site': site, 'section': section, 'url': 'https://strefadb.pl/odcinki/dbz_abridged.html'}, {'title': 'DBZ Abridged'}, is_folder=True, fanart=fanartdragon, img=iconstrefadballs)
