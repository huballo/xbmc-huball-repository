...
def ps(x):
    if (x == '_addon_id') or (x == 'addon_id') or (x == '_plugin_id') or (x == 'plugin_id'):
        return 'plugin.video.anime-iptv'
    try:
        return {
            '__plugin__':                     "A[COLOR white]nime[COLOR red]44[/COLOR][/COLOR]"
            ...
            ,'content_episodes':         "episodesDiff"
            ,'content_episodes':         "episodesCentrum"
            ,'content_episodes':         "EpisodesDramaQueen_drama"
            ,'content_episodes':         "episodesAnimeonline"
            ,'content_links':             "list"
